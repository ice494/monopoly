...
<body>
    ...
    <div id="game-screen">
        <div class="game-container">
            <button class="sidebar-toggle" id="sidebar-toggle" title="菜单">☰</button>
